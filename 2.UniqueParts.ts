...
scope1a(); // prints "bottom" - no error
...
scope1b(); // prints "bottom" - no error

function scope2a(print) {
  if (print) {
    var insideIf = "12";
  }
  // @ts-ignore
...
scope2a(true); // prints '12' - no error

function scope2b(print) {
  var insideIf;
...
scope2b(true); // prints '12' - no error
